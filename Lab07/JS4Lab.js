 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`${myfriendsName} & ${myName} are eating ${food} and drinking ${drink} at a restaurant.`)
...
//Answer: It does not allow reassigment to a const variable.
...
const lunchTime = (foodChoice,drinkChoice) => {
   return `${myfriendsName} & ${myName} are eating ${foodChoice} and drinking ${drinkChoice} at a restaurant.`
}
console.log(lunchTime('Pizza','Water'))
...
console.log(foodForTodayAndTomorrow('Hamburger', 'Sprite', lunchTime('Pizza', 'Wine')))
