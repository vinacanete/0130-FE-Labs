...
// another way to do this, shorter
...
console.log("step 4a-push: " + (array1.push('16','3')));
console.log("step 4b-print: " + array1);
console.log("step 5: " + array1[2]);
console.log("step 5: " + array1[array1.length-1]);
...
console.log("step 2a-push: " + myTodoList.push('homework', 'laundry', 'clean'));
console.log("step 2b-print: " + myTodoList);
